...
public class CardInfoActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String result = intent.getStringExtra(CheckCardActivity.EXTRA_CARD_INFO);
        ...
        //If no cards are in the DB, we go to the AddCardActivity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((CardInfoActivity) activity).onSectionAttached(
    ...
    public void populateInfo(String info){
        ...
        try{
            ...
            mPartialMediaSerialNbr.setText(JSONinfo.getString("partialMediaSerialNbr"));
            mTransitAccountId.setText(JSONinfo.getString("transitAccountId"));
            mAccountStatus.setText(JSONinfo.getString("accountStatus"));
            mBalance.setText(JSONinfo.getString("totalBalanceAndPretaxBalance"));
            mPasses.setText(JSONinfo.getJSONArray("passes").toString());
            mRiderClassDescription.setText(JSONinfo.getString("riderClassDescription"));
