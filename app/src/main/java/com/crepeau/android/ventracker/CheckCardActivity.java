...
public class CheckCardActivity extends Activity {
    ...
    public final static String EXTRA_CARD_INFO = "com.crepeau.android.ventracker.CARD_INFO";
    public final static String EXTRA_CARD_DATA = "com.crepeau.android.ventracker.CARD_DATA";
